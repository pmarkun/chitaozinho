...
Crie cada bucket já com Object Lock habilitado. Essa propriedade não deve ser
adicionada posteriormente. Para o ensaio isolado, use retenção padrão de um dia
em modo `COMPLIANCE`; staging e produção exigem ao menos 90 dias. Depois execute
`scripts/test-s3-object-lock` com dados sintéticos e guarde o relatório privado.
